...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="lnk45678", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        edit_menu_item.triggered.connect(self.insert_search)
    ...
    def insert_search(self):
        dialog_search = InsertSearchDialog()
        dialog_search.exec()
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        course_name = app_main.table.item(index, 2).text()
        ...
        # Add mobile widget
        mobile = app_main.table.item(index, 3).text()
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout = QGridLayout()
        confirmation = QLabel("Are your sure you want to delete?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
...
class InsertSearchDialog(QDialog):
    def __init__(self):
        ...
        # Add search by the name widget
        self.search_name = QLineEdit()
        self.search_name.setPlaceholderText("Name")
        layout_search.addWidget(self.search_name)
    ...
    def search(self):
        ...
        rows = list(result)
        print(rows)
        items = app_main.table.findItems(name, Qt.MatchFlag.MatchFixedString)
        for item in items:
            print(item)
            app_main.table.item(item.row(), 1).setSelected(True)
